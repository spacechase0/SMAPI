...
public abstract class NpcFacade_1_6 : NPC, IRewriteFacade
{
    /*********
    ** Accessors
    *********/
    ...
    *********/
    ...
    {
        return new NPC(sprite, position, defaultMap, facingDirection, name, portrait);
    }
    ...
    public bool isBirthday(string season, int day)
    {
        ...
        return
            ...
            && base.Birthday_Season.Value == parsedSeason
    ...
    public void showTextAboveHead(string Text, int spriteTextColor = -1, int style = SpeechBubble.textStyle_none, int duration = 3000, int preTimer = 0)
    {
